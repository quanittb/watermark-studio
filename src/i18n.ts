...
const dictionary = {
  vi: {
    ...
    importVideos: "Import nhiều video", findSamples: "Tìm mẫu tốt nhất", findSamplesAll: "Tự động tìm mẫu (6 phase)", autoCalibrate: "Tự động tìm, hiệu chỉnh và kiểm chứng", calibrating: "Đang tìm, hiệu chỉnh và kiểm chứng…", scanning: "Đang quét…", scanningAllPhases: "Đang quét đủ 6 phase quỹ đạo…", queueRender: "Đưa vào hàng đợi", findAlternatives: "Tìm 5 mẫu thay thế (6 phase)", alternativesHint: "Chưa mẫu nào đạt chuẩn theo mắt? Lượt thay thế sẽ quét lại đủ 6 phase, loại ±72 frame và scene vừa xem.", roiFallbackActive: "ROI fallback đang bật: kéo vùng tương đối trên preview, không cần khoanh sát từng glyph.", roiFit: "Khớp quỹ đạo theo ROI này", viewQa: "Xem QA", contactSheet: "Contact sheet", openOutput: "Mở output", openFolder: "Mở thư mục",
    general: "Chung", processing: "Xử lý", updates: "Cập nhật", advanced: "Nâng cao", about: "Giới thiệu", recheckPromote: "Kiểm tra QA / chốt output",
  ...
  en: {
    ...
    importVideos: "Import videos", findSamples: "Find best samples", findSamplesAll: "Auto-find samples (6 phases)", autoCalibrate: "Auto-detect, calibrate and verify", calibrating: "Detecting, calibrating and verifying…", scanning: "Scanning…", scanningAllPhases: "Scanning all 6 trajectory phases…", queueRender: "Queue render", findAlternatives: "Find 5 alternatives (6 phases)", alternativesHint: "Not satisfied with these samples? The next pass scans all 6 phases, excludes ±72 frames and the scenes already shown.", roiFallbackActive: "ROI fallback is enabled: draw a relative region in the preview; tight glyph tracing is not required.", roiFit: "Fit trajectory from this ROI", viewQa: "View QA", contactSheet: "Contact sheet", openOutput: "Open output", openFolder: "Open folder",
    general: "General", processing: "Processing", updates: "Updates", advanced: "Advanced", about: "About", recheckPromote: "Recheck QA / promote",
