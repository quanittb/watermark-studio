...
export default function App() {
  ...
  const interpolateCurrentRange = async () => {
    ...
    try { setProject(await interpolateTrackingRange(project.id, range.startFrame, range.endFrame)); setSelection(null); setMessage('Range interpolated provisionally; review each affected range before rendering.'); }
