...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::project::start_auto_calibration_v9,
            commands::project::validate_calibration_v9,
            ...
            commands::project::revalidate_output_v9,
            commands::project::enqueue_best_quality_job,
            commands::project::enqueue_hybrid_v9,
